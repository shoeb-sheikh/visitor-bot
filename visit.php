...
echo " code write by Shoeb SHeikh \n ";
echo " inforamtion ";
echo " \n";
echo "this tool able to increase the views of your website or blog\n";
echo "  \n";
echo " you can increase upto 99999 views \n";
echo "  \n";
...
for($i = 1; $i < $max+1; $i++) {
	...
	echo $i.". VISITOR visit the site - [".$class->jalankan()."\n";
}
?>
